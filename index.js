...
let a = 100;
var b = 200;
/*let and const aRE CANT BE hoisted because it enablews the temporal dead zone.
meaning the variable is unreachable before it is declared. */
...
// x = 4;                     //514...Uncaught ReferenceError: Cannot access 'x' before initialization
// console.log(x)               //hoisting is not allowed in let.
// let x;             
...
// let f = 93476;         //becuse let doesnt allow hoisting.
...
// h = 6523            //index.js:480 Uncaught ReferenceError: Cannot access 'h' before initialization
// console.log(h)
// let h;
...
function loadData() {
    ...
    //create request
    srinu.open("GET", 'demo.json', true);  //there are five parameters in the this Open() method, they are 1.'GET'/"POST" 2.URL 3.async 4.username, 5.password.
    //send Request...
    srinu.send();
    ...
    srinu.onload = function () {
        let result = srinu.responseText;
        console.log(typeof result);
        let resultObj = JSON.parse(result);
        console.log(JSON.parse(result))
        dataEle.innerText = resultObj;
        console.log(typeof resultObj);
        // dataEle.innerText = result;
    }
